...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { Auteur: @art.Auteur, Date: @art.Date, Description: @art.Description, Dimensions: @art.Dimensions, Titre: @art.Titre, Œuvre: @art.Œuvre } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { Auteur: @art.Auteur, Date: @art.Date, Description: @art.Description, Dimensions: @art.Dimensions, Titre: @art.Titre, Œuvre: @art.Œuvre } }
